        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
                ...
                <td class="nw">
                    ...
                    <a class="btn btn-xs btn-danger" href="aksi.php?act=gejala_hapus&ID=<?=$row->kode_gejala?>" onclick="return confirm('Apakah Anda Ingin Menghapus Gejala Ini?')"><span class="glyphicon glyphicon-trash"></span></a>
                </td>
            </tr>
            <?php endforeach;?>
        </table>
