...
<?php if ($success) : ?>
    <div class="panel panel-primary">
        ...
        <div class="panel-body text-center">
            ...
            <form action="simpan.php" method="post">
                ...
                <p>&nbsp;</p>
                <p>
                    <a class="btn btn-success" href="?m=detail_konsultasi&ID=<?=$row->kode_diagnosa?>"><span class="glyphicon glyphicon-eye-open"></span> Lihat Detail</a>
    ...
    <div class="list-group">
        ...
        $no = 1;
        foreach ($rows as $row) : ?>
            <div class="list-group-item"><?= $no++ ?>. Apakah Sugar Glider Anda <?= strtolower($row->nama_gejala) ?>? <strong><?= $row->jawaban ?></strong></div>
        <?php endforeach ?>
    </div>
...
<?php else : ?>
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <h3>Apakah Sugar Glider Anda <?= strtolower($GEJALA[$kode_gejala]) ?>?</h3>
            <form action="simpan.php" method="post">
